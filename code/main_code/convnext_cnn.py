...
def save_predictions(predictions, labels, iteration):
    ...
    filename = f'convnext_predictions_{model_name}_iteration{iteration}_{timestamp}.csv'
    ...
    report_filename = f'convnext_classification_report_{model_name}_iteration{iteration}_{timestamp}.csv'
...
def plot_training_curves(train_losses, val_losses, train_jaccards, val_jaccards, iteration):
    ...
    plt.ylabel('Loss')
    plt.legend()
    loss_plot_filename = f'convnext_loss_plot_{model_name}_iteration{iteration}_{timestamp}.png'
    ...
    plt.legend()
    acc_plot_filename = f'convnext_accuracy_plot_{model_name}_iteration{iteration}_{timestamp}.png'
