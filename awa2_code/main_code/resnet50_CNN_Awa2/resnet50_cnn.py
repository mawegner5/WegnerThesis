...
target_jaccard_score = 0.75    # Target Jaccard score for initial training
...
def train_initial_model():
    ...
    for epoch in range(num_epochs):
        ...
        # Check if target Jaccard score is reached
        if best_jaccard >= target_jaccard_score:
            print(f"Target Jaccard score of {target_jaccard_score} reached.")
            break
