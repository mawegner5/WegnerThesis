...
# Model configuration
model_name = 'regnet_y_400mf'  # Options: 'regnet_y_400mf', 'regnet_y_800mf', etc.
...
def train_initial_model():
    ...
    # Modify the final layer to match the number of attributes and add dropout
...
if __name__ == '__main__':
    ...
    study.optimize(train_optuna_model, n_trials=n_trials)
